...
<head>
    ...
    <meta name="keywords"
          content="iPress, magazine, light, dark, themeforest, multi purpose, premium, unlimited, blog, news, AD, optimized">
...
<div id="layout" class="boxed">
    <header id="header">
            ...
            <div class="row clearfix">
                <div class="breaking_news lefter">
                    ...
                    <ul id="js-news" class="js-hidden">
                        <li class="news-item"><a href="#">Improving Search on the Envato Marketplaces: 2013 in
                                Review</a></li>
                        <li class="news-item"><a href="#">4 Ways To Find Free and Unique Photos for Your Next Website
                                Theme</a></li>
                        <li class="news-item"><a href="#">Community Poll: Internet Speeds From Around the World in
                                2013</a></li>
                        <li class="news-item"><a href="#">New Hub, Header & Collections: 10 Ways to Improve Your
                                Marketplaces Productivity</a></li>
                        <li class="news-item"><a href="#">Get a Free Year of Tuts+ Premium by Trying New Relic</a></li>
                        <li class="news-item"><a href="#">Beyond Bland: 10+ Creative Packaging Designs That Will Leave
                                You Inspired</a></li>
                    </ul>
                    <!-- /js news -->
                </div>
        ...
        <div class="b_head">
            <div class="row clearfix">
                <div class="logo">
                    <a href="{{ route('homepage') }}" title="iPress - Responsive News/Blog/Magazine HTML5"><img
                                src="/themes/ipress/images/logo.png" alt="iPress - Responsive News/Blog/Magazine HTML5"></a>
                </div>
                <!-- /logo -->
                <?php echo $topAdvBox ?>
        ...
        <div class="row clearfix">
            <div class="sticky_true">
                <div class="c_head clearfix">
                    <nav>
                        <ul class="sf-menu">
                            <li class="current colordefault home_class"><a href="{{ route('homepage') }}"><i
                                            class="icon-home"></i></a>
                                <ul>
                    ...
                    <div class="right_icons">
                        ...
                        <div class="search">
                            ...
                            <div class="s_form">
                                <form action="http://theme20.com/demo/ipress/search_result.html" id="search"
                                      method="get">
